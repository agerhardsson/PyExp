...
class GUI():
    ...
    def createBox(self):
        ...
        self.lab_date.grid(row=3, sticky='e')
        self.lab_time.grid(row=4, sticky='e')
        ...
        self.buttonCancel.grid(row=5, column=0, sticky='w')
        self.buttonOK.grid(row=5, column=1, sticky='e')
