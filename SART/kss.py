...
class KSS():
    ...
    def __init__(self, win, textCol='black', textSize=.07):
        ...
        self.pos['kss2'] = [self.pos['right'], self.pos['top'] - .11]
        self.pos['kss3'] = [self.pos['right'], self.pos['top'] - .21]
        self.pos['kss4'] = [self.pos['right'], self.pos['top'] - .31]
        self.pos['kss5'] = [self.pos['right'], self.pos['top'] - .41]
        self.pos['kss6'] = [self.pos['right'], self.pos['top'] - .51]
        self.pos['kss7'] = [self.pos['right'], self.pos['top'] - .61]
        self.pos['kss8'] = [self.pos['right'], self.pos['top'] - .71]
        self.pos['kss9'] = [self.pos['right'], self.pos['top'] - .85]
        self.pos['key1'] = [self.pos['right'] + keyHorizAdj,
                            self.pos['top']]
        self.pos['key2'] = [self.pos['right'] + keyHorizAdj,
                            self.pos['top'] - .1]
        self.pos['key3'] = [self.pos['right'] + keyHorizAdj,
                            self.pos['top'] - .2]
        self.pos['key4'] = [self.pos['right'] + keyHorizAdj,
                            self.pos['top'] - .3]
        self.pos['key5'] = [self.pos['right'] + keyHorizAdj,
                            self.pos['top'] - .4]
        self.pos['key6'] = [self.pos['right'] + keyHorizAdj,
                            self.pos['top'] - .5]
        self.pos['key7'] = [self.pos['right'] + keyHorizAdj,
                            self.pos['top'] - .6]
        self.pos['key8'] = [self.pos['right'] + keyHorizAdj,
                            self.pos['top'] - .7]
        self.pos['key9'] = [self.pos['right'] + keyHorizAdj,
                            self.pos['top'] - .81]
    ...
    def scale(self):
        ...
        kssDict['kssText'] = [
            u'Hur sömnig känner du dig just nu?',
            u'1\tExtremt pigg',
            u'2\tMycket pigg',
            u'3\tPigg',
            u'4\tGanska pigg',
    ...
    # create log function -----------------------------------------------------
    def log(self, subjId, dataDict, folder='data'):
        dir = folder
        subject_id = subjId
        data = dataDict
